        ...
        <div id="sidebar-alt" tabindex="-1" aria-hidden="true">
            ...
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 888px;">
                ...
                <div class="slimScrollBar"
                     style="background: rgb(187, 187, 187); width: 3px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 888px;"></div>
                <div class="slimScrollRail"
                     style="width: 3px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 1; z-index: 90; right: 1px;"></div>
            </div>
        </div>
        <div id="sidebar">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a class="<?php echo checkIfActive('index,') ?>" href="./">
                                <i class="fa fa-home sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">后台首页</span>
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo checkIfActive('list,export') ?>" href="./list.php">
                                <i class="fa fa-list sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">订单管理</span>
                            </a>
                        </li>
                        ...
                        <li class="<?php echo checkIfActive('classlist,shoplist,shopedit,price,shoprank,cardlist') ?>">
                            <a href="javascript:void(0)" class="sidebar-nav-menu"><i
                                        ...
                                        class="sidebar-nav-mini-hide">商品管理</span></a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a class="<?php echo checkIfActive("shoplist,shopedit,shoprank") ?>"
                                       href="./shoplist.php">
                                        商品列表
                                    </a>
                                </li>
                        ...
                        <li class="<?php echo checkIfActive('fakalist,fakakms,mailcon') ?>">
                            <a href="javascript:void(0)" class="sidebar-nav-menu"><i
                                        class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
                                        class="fa fa-th sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">发卡管理</span></a>
                            <ul>
                                <li>
                        ...
                        <li class="<?php echo checkIfActive('sitelist,tixian,record,rank,userlist,message,workorder,siteprice,kmlist,app_list') ?>">
                            <a href="javascript:void(0)" class="sidebar-nav-menu"><i
                                        class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
                                        class="fa fa-sitemap sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">分站管理</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="<?php echo checkIfActive('article,rewrite') ?>" href="./article.php">
                                <i class="fa fa-book sidebar-nav-icon"></i><span
                                        class="sidebar-nav-mini-hide">文章管理</span>
                            </a>
                        </li>
                        ...
                        <li class="<?php echo checkIfActive('site,gonggao,mail,pay,template,template2,upimg,upbgimg,clean,cleanbom,defend,proxy,copygg,mailtest,epay,captcha,fenzhan,cron,oauth') ?>">
                            <a href="javascript:void(0)" class="sidebar-nav-menu"><i
                                        ...
                                        class="sidebar-nav-mini-hide">系统设置</span></a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a class="<?php echo checkIfActive("gonggao,copygg") ?>"
                                       href="./set.php?mod=gonggao">
                                        网站公告配置
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="<?php echo checkIfActive("template,template2") ?>"
                                       href="./set.php?mod=template">
                                        首页模板设置
                                    </a>
                                </li>
                                <li>
                        ...
                        <li class="<?php echo checkIfActive('qiandao,invite,dwz,choujiang,invitelog,appCreate') ?>">
                            <a href="javascript:void(0)" class="sidebar-nav-menu"><i
                                        ...
                                        class="sidebar-nav-mini-hide">其它组件</span></a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a class="<?php echo checkIfActive("invite,invitelog") ?>"
                                       href="./set.php?mod=invite">
                                        推广链接设置
                                    </a>
                                </li>
                                <li>
